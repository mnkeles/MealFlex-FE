...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'mf-xs': '0 1px 2px rgba(44, 42, 35, .035)',
        'mf-sm': '0 2px 6px rgba(44, 42, 35, .045)',
        card: '0 1px 2px rgba(44, 42, 35, .035), 0 7px 20px rgba(44, 42, 35, .045)',
        floating: '0 12px 30px rgba(44, 42, 35, .12)',
        'mf-lg': '0 20px 48px rgba(44, 42, 35, .14)',
      },
    },
  },
  plugins: [],
