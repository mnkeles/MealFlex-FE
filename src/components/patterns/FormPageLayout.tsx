...
export default function FormPageLayout({
  ...
  return (
    <div className="mf-page pb-24">
      ...
      {saveBar && (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[#e7e7e7] bg-white/95 p-3 shadow-floating backdrop-blur sm:left-auto sm:right-6 sm:bottom-6 sm:w-auto sm:rounded-2xl sm:border">
          {saveBar}
        </div>
      )}
    </div>
