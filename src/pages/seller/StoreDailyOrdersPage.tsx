...
export default function StoreDailyOrdersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <section className="rounded-xl border border-primary-100 bg-white p-4 shadow-card">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="font-semibold text-ink">Bugünün mutfak özeti</h2>
      ...
      {routePlan?.stops.length ? (
        <section className="mb-4 rounded-xl border border-info-200 bg-info-50 p-4">
          <h3 className="font-semibold text-info-900">Rota önerisi</h3>
      ...
      {bulkResult && (
        ...
        >
          <p className="font-semibold">Toplu işlem tamamlandı</p>
          <p className="mt-1">
          ...
          {!!bulkResult.failed.length && (
            <button
              ...
              className="mt-3 rounded-lg border border-warning-300 bg-white px-3 py-2 text-xs font-semibold"
            >
      ...
      {!!exceptions.length && (
        <section className="mb-4 rounded-xl border border-danger-200 bg-danger-50 p-4">
          <h3 className="flex items-center gap-2 font-semibold text-danger-800">
          ...
          <section className="grid gap-3 overflow-x-auto pb-2 md:grid-cols-2 xl:grid-cols-4">
            {(
              ...
              return (
                <div
                  key={status}
                  className="min-w-64 rounded-xl bg-slate-100 p-3"
                >
